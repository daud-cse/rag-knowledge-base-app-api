...
builder.Services.AddDbContext<AppDbContext>(options =>
{
    ...
    {
        var path = Path.Combine(builder.Environment.ContentRootPath, "App_Data", "uttorai.db");
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "Uttor AI Enterprise RAG API",
        Version = "v1",
...
app.UseSwagger();
app.UseSwaggerUI(o => o.DocumentTitle = "Uttor AI API");
app.UseCors("ui");
