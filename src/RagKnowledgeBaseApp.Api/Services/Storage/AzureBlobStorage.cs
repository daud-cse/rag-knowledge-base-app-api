...
namespace RagKnowledgeBaseApp.Api.Services.Storage;
...
public class AzureBlobOptions
{
    ...
    public string Container { get; set; } = "ragkb-documents";
...
public class AzureBlobStorage : IDocumentStorage
{
    ...
    /// is readable in Storage Explorer (<c>ragkb-documents-contoso</c> rather than a raw guid).
